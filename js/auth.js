	...
	//здесь при нажатии на кнопку провер€етс€ логин и пароль с теми которые хран€тс€ в localstorage
	//если они совпадают то мы записываем в user_id текущий id пользовател€ и заходим на его страницу
	...
	if (password=="") {
	     alert("¬ведите пароль пожалуйста!");		
	    }

	if(flag_name==false){
			alert("“акой пользователь не зарегистрирован на сайте!");
		}

	if(flag_pass==false){
			alert("ѕароль не правильный. ѕовторите попытку!");
		}
